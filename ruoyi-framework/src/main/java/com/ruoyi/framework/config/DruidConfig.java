...
public class DruidConfig {
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.alipay")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.alipay", name = "enabled", havingValue = "true")
    public DataSource alipayDataSource(DruidProperties druidProperties) {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }

    @Bean
    @ConfigurationProperties("spring.datasource.druid.pay")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.pay", name = "enabled", havingValue = "true")
    public DataSource payDataSource(DruidProperties druidProperties) {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
